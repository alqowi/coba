...
exports.doCharge = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-ypmWWwIAvNZDUZiQ0cS3293q').toString('base64'); // Dummy Charge Token
...
exports.doChargeProd = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-ypmWWwIAvNZDUZiQ0cS3293q:').toString('base64');
